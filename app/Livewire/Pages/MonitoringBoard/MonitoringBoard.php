...
namespace App\Livewire\Pages\MonitoringBoard;
...
#[Lazy]
#[Layout('layouts.app')]
class MonitoringBoard extends Component
{
  ...
  #protected variables
	protected $montoring_board_service;
  ...
  public bool $is_success = false;
	...
	public function boot(
		MonitoringBoardService $montoring_board_service,
	)
	{
		$this->montoring_board_service = $montoring_board_service;
	}
  ...
  //   }
	...
	public function render(){
		return view('livewire.pages.monitoring-board.monitoring-board');
	}
