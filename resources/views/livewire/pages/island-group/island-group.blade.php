<div>
  ...
  <x-mary-modal wire:model="addIslandGroupModal" class="backdrop-blur custom-modal top-modal">
    ...
    <x-mary-form wire:submit.prevent="save_island_group" no-separator>
      ...
      <x-slot:actions>
          ...
          <x-mary-button label="Save Record" class="btn-primary" type="submit" spinner="save_island_group" />
      </x-slot:actions>
  ...
  <x-mary-modal wire:model="editIslandGroupModal" class="backdrop-blur custom-modal top-modal">
    ...
    <x-mary-form wire:submit.prevent="save_island_group_record_changes" no-separator>
      ...
      <x-slot:actions>
        ...
        <x-mary-button label="Save Record" class="btn-primary" type="submit" spinner="save_island_group_record_changes" />
      </x-slot:actions>
    </x-mary-form>
  </x-mary-modal>
  ...
  <x-mary-modal wire:model="updateIslandGroupStatusModal" class="backdrop-blur" title="Please Confirm Action?" separator>
    ...
    <x-slot:actions>
        ...
        <x-mary-button label="Confirm" class="btn-primary" spinner="delete" wire:click="update_island_group_status({{ $island_group_id }}, {{ $statuscode }})"  />
    </x-slot:actions>
