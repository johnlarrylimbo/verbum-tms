<div>
  ...
  <x-mary-modal wire:model="editClientCategoryModal" class="backdrop-blur">
    <x-mary-form wire:submit.prevent="save_client_category_record_changes" no-separator>
      ...
      <x-slot:actions>
        ...
        <x-mary-button label="Save Record" class="btn-primary" type="submit" spinner="save_client_category_record_changes" />
      </x-slot:actions>
    </x-mary-form>
  </x-mary-modal>  
  ...
  <x-mary-modal wire:model="updateClientCategoryStatusModal" class="backdrop-blur" title="Please Confirm Action?" separator>
    ...
    <x-slot:actions>
        ...
        <x-mary-button label="Confirm" class="btn-primary" spinner="delete" wire:click="update_client_category_status({{ $client_category_id }}, {{ $statuscode }})"  />
    </x-slot:actions>
